...
<head>
    <title>Virtual Assistant - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="hero-wrap" style="background-image: url('dashboard/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-fullwidth goto-here">
    	...
    	<div class="container-fluid px-0">
    		<div class="row d-sm-flex text-wrapper align-items-stretch">
					<div class="one-half mb-md-0 mb-4 img d-flex align-self-stretch" style="background-image: url('dashboard/images/about.jpg');"></div>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt">
			<div class="container">
				<div class="row">
					<div class="col-md-6 img img-3 d-flex justify-content-center align-items-center" style="background-image: url(dashboard/images/about-1.jpg);">
					</div>
                ...
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(dashboard/images/person_1.jpg)"></div>
                    	<div class="pl-3">
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(dashboard/images/person_2.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(dashboard/images/person_3.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
              	<a href="blog-single.html" class="block-20 img" style="background-image: url('dashboard/images/image_1.jpg');">
	              </a>
	              <div class="meta mb-1">
          ...
          <div class="col-md-3 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <div class="text">
              	<a href="blog-single.html" class="block-20 img" style="background-image: url('dashboard/images/image_2.jpg');">
	              </a>
	              <div class="meta mb-1">
                  <div><a href="#">April 12, 2020</a></div>
                  <div><a href="#">Admin</a></div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <div class="text">
              	<a href="blog-single.html" class="block-20 img" style="background-image: url('dashboard/images/image_3.jpg');">
	              </a>
	              <div class="meta mb-1">
                  <div><a href="#">April 12, 2020</a></div>
                  <div><a href="#">Admin</a></div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <div class="text">
              	<a href="blog-single.html" class="block-20 img" style="background-image: url('dashboard/images/image_4.jpg');">
	              </a>
	              <div class="meta mb-1">
                  <div><a href="#">April 12, 2020</a></div>
                  <div><a href="#">Admin</a></div>
    ...
    <section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb img" style="background-image: url(dashboard/images/bg_2.jpg);">
			<div class="overlay"></div>
    	<div class="container">
