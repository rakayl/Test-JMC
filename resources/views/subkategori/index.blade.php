...
<div class="table-area">
    <div class="table-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="title mb-0">{{ __("All Sub Kategori") }}</h5>
            <div class="d-flex gap-3 align-items-center">
                ...
                @include('admin.components.link.add-default',[
                    'href' => "#subkategori-add",
                    'class' => "modal-btn",
                    'text' => __('Add Sub Kategori'),
                    'permission' => "subkategori.store"
                ])
            </div>
        </div>
        ...
        <div class="table-responsive">
            <div class="entry-wrapper d-flex align-items-center">
                <form action="{{ Route('subkategori.index') }}" method="GET" class="d-flex align-items-center">
            ...
            @include('subkategori.table',compact("data"))
        </div>
        {{ get_paginate($data) }}
    </div>
</div>
...
{{-- Admin Add Modal --}}
@include('subkategori.add')

{{-- Admin Edit Modal --}}
@include('subkategori.edit')
@endsection
...
$(document).on("click",".delete-modal-button",function() {
    ...
    var actionRoute = "{{ setRoute('subkategori.delete') }}";
    var target = oldData;
    var message = `{{ __("anda hendak menghapus ") }} <strong>Sub Kategori</strong> ini, apakah anda yakin ingin melakukannya ?`;
    var title = "ingin menghapus sub kategori ini ?"
